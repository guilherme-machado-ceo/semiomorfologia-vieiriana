...
setup(
    ...
    extras_require={
        ...
        "api": ["fastapi>=0.100.0", "uvicorn>=0.23.0", "typer>=0.9.0"],
        "visualization": ["networkx>=3.0", "pyvis>=0.3.0"],
        "knowledge": ["sparqlwrapper>=2.0.0", "requests>=2.28.0"],
        "all": [
            "sentence-transformers>=2.2.0",
            "fastapi>=0.100.0", "uvicorn>=0.23.0", "typer>=0.9.0",
            "networkx>=3.0", "pyvis>=0.3.0",
            "sparqlwrapper>=2.0.0", "requests>=2.28.0",
        ],
    },
    entry_points={"console_scripts": ["semiomorf=semiomorfologia.cli:app"]},
)
